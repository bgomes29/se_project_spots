...
function getCardElement(data){
    ...
    const cardImageEl = imageElement.querySelector(".card__image");
...
function openModal() {
    ...
    editModalDescriptionInput.value = descriptionInput.textContent;
...
function handleEditFormSubmit(evt){
    ...
    descriptionInput.textContent = editModalDescriptionInput.value;
    closeModal();
}
